...
console.log(res.data.Bills[i].BillID)
...
billsInfo.push({StateBillID,StateCode, BillName, Summary, Sponsors, LastAction, ActionDate, BillProgress, OfficialDocument, Created})
 

 if(BillProgress === "1 - Introduced" || BillProgress === "2 - In Committee" || BillProgress === "3 - Crossed Over" || BillProgress === "4 - Passed"){
     billsInfoActive.push({StateBillID,StateCode, BillName, Summary, Sponsors, LastAction, ActionDate, BillProgress, OfficialDocument, Created})
    }
}
 console.log(i)
...
module.exports = { billsInfo: billsInfo, billsInfoActive: billsInfoActive };
